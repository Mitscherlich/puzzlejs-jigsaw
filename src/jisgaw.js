...
function getRandomImg() {
  return (
    'https://source.unsplash.com/300x150?v=' + getRandomNumberByRange(0, 100)
  );
}
...
export class Jigsaw {
  ...
  verify() {
    const arr = this.trail; // 拖动时 y 轴的移动距离
    ...
    return {
      ...
      TuringTest: average !== stddev, // 只是简单的验证拖动轨迹，相等时一般为 0，表示可能非人为操作
    };
  }
